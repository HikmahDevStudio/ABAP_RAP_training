...
@EndUserText.label: 'CDS Entity Booking'
@Metadata.ignorePropagatedAnnotations: true
@VDM.viewType: #COMPOSITE
define view entity ZHDS_RTR_BOOKING as select from /dmo/booking_m

composition[0..*] of ZHDS_RTR_BOOKINGSUPPL as _BookingSuppl

association to parent ZHDS_RTR_TRAVEL as _Travel
...
on $projection.CarrierId = _Connection.AirlineID and $projection.ConnectionId = _Connection.ConnectionID
